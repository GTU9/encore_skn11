...
# 동적 페이지 : 요청한 URL에서 응답받은 HTML 안의 JS를 실행해 HTML을 새로 만든 경우 (CSR : Client Side Rending)
...
# 5. 특정 요소에 접근
news_content_elems=driver.find_elements(By.CSS_SELECTOR, '.news_contents')
print(len(news_content_elems))

for news_contents_elem in news_content_elems:
